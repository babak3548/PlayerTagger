...
// TestMuxerApp.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CTestMuxerApp, CWinApp)
	ON_COMMAND(ID_HELP, CWinApp::OnHelp)
END_MESSAGE_MAP()


// CTestMuxerApp construction

CTestMuxerApp::CTestMuxerApp()
{
...
// The one and only CTestMuxerApp object

CTestMuxerApp theApp;


// CTestMuxerApp initialization

BOOL CTestMuxerApp::InitInstance()
{
