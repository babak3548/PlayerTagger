...
{"Alemannic","Swiss German; Alemannic; Alsatian","suisse alémanique; alémanique; alsacien","gsw","",},
{"Aleut","Aleut","aléoute","ale","",},
{"Algonquian languages","Algonquian languages","algonquines, langues","alg","",},
{"Alsatian","Swiss German; Alemannic; Alsatian","suisse alémanique; alémanique; alsacien","gsw","",},
{"Altaic languages","Altaic languages","altaïques, langues","tut","",},
...
{"Armenian","Armenian","arménien","arm/hye","hy",},
{"Aromanian","Aromanian; Arumanian; Macedo-Romanian","aroumain; macédo-roumain","rup","",},
{"Artificial languages","Artificial languages","artificielles, langues","art","",},
{"Arumanian","Aromanian; Arumanian; Macedo-Romanian","aroumain; macédo-roumain","rup","",},
{"Assamese","Assamese","assamais","asm","as",},
{"Asturian","Asturian; Bable; Leonese; Asturleonese","asturien; bable; léonais; asturoléonais","ast","",},
{"Asturleonese","Asturian; Bable; Leonese; Asturleonese","asturien; bable; léonais; asturoléonais","ast","",},
...
{"Austronesian languages","Austronesian languages","austronésiennes, langues","map","",},
{"Avaric","Avaric","avar","ava","av",},
{"Avestan","Avestan","avestique","ave","ae",},
{"Awadhi","Awadhi","awadhi","awa","",},
{"Aymara","Aymara","aymara","aym","ay",},
{"Azerbaijani","Azerbaijani","azéri","aze","az",},
{"Bable","Asturian; Bable; Leonese; Asturleonese","asturien; bable; léonais; asturoléonais","ast","",},
...
{"Bamileke languages","Bamileke languages","bamiléké, langues","bai","",},
...
{"Belarusian","Belarusian","biélorusse","bel","be",},
{"Bemba","Bemba","bemba","bem","",},
{"Bengali","Bengali","bengali","ben","bn",},
{"Berber languages","Berber languages","berbères, langues","ber","",},
...
{"Bokmål, Norwegian","Bokmål, Norwegian; Norwegian Bokmål","norvégien bokmål","nob","nb",},
...
{"Central American Indian languages","Central American Indian languages","amérindiennes de l'Amérique centrale,  langues","cai","",},
{"Central Khmer","Central Khmer","khmer central","khm","km",},
{"Chagatai","Chagatai","djaghataï","chg","",},
{"Chamic languages","Chamic languages","chames, langues","cmc","",},
{"Chamorro","Chamorro","chamorro","cha","ch",},
{"Chechen","Chechen","tchétchène","che","ce",},
...
{"Church Slavic","Church Slavic; Old Slavonic; Church Slavonic; Old Bulgarian; Old Church Slavonic","slavon d'église; vieux slave; slavon liturgique; vieux bulgare","chu","cu",},
{"Church Slavonic","Church Slavic; Old Slavonic; Church Slavonic; Old Bulgarian; Old Church Slavonic","slavon d'église; vieux slave; slavon liturgique; vieux bulgare","chu","cu",},
...
{"Creoles and pidgins","Creoles and pidgins","créoles et pidgins","crp","",},
{"Creoles and pidgins, English based","Creoles and pidgins, English based","créoles et pidgins basés sur l'anglais","cpe","",},
{"Creoles and pidgins, French-based","Creoles and pidgins, French-based","créoles et pidgins basés sur le français","cpf","",},
{"Creoles and pidgins, Portuguese-based","Creoles and pidgins, Portuguese-based","créoles et pidgins basés sur le portugais","cpp","",},
{"Crimean Tatar","Crimean Tatar; Crimean Turkish","tatar de Crimé","crh","",},
{"Crimean Turkish","Crimean Tatar; Crimean Turkish","tatar de Crimé","crh","",},
{"Croatian","Croatian","croate","hrv","hr",},
{"Cushitic languages","Cushitic languages","couchitiques,  langues","cus","",},
{"Czech","Czech","tchèque","cze/ces","cs",},
...
{"Dutch","Dutch; Flemish","néerlandais; flamand","dut/nld","nl",},
{"Dutch, Middle (ca.1050-1350)","Dutch, Middle (ca.1050-1350)","néerlandais moyen (ca. 1050-1350)","dum","",},
...
{"Efik","Efik","efik","efi","",},
{"Egyptian (Ancient)","Egyptian (Ancient)","égyptien","egy","",},
{"Ekajuk","Ekajuk","ekajuk","eka","",},
{"Elamite","Elamite","élamite","elx","",},
...
{"Ewe","Ewe","éwé","ewe","ee",},
{"Ewondo","Ewondo","éwondo","ewo","",},
{"Fang","Fang","fang","fan","",},
{"Fanti","Fanti","fanti","fat","",},
{"Faroese","Faroese","féroïen","fao","fo",},
...
{"Flemish","Dutch; Flemish","néerlandais; flamand","dut/nld","nl",},
{"Fon","Fon","fon","fon","",},
{"French","French","français","fre","fr",},
{"French","French","français","fra","fr",},
{"French, Middle (ca.1400-1600)","French, Middle (ca.1400-1600)","français moyen (1400-1600)","frm","",},
{"French, Old (842-ca.1400)","French, Old (842-ca.1400)","français ancien (842-ca.1400)","fro","",},
{"Friulian","Friulian","frioulan","fur","",},
{"Fulah","Fulah","peul","ful","ff",},
{"Ga","Ga","ga","gaa","",},
{"Gaelic","Gaelic; Scottish Gaelic","gaélique; gaélique écossais","gla","gd",},
...
{"Geez","Geez","guèze","gez","",},
{"Georgian","Georgian","géorgien","geo/kat","ka",},
...
{"Haitian","Haitian; Haitian Creole","haïtien; créole haïtien","hat","ht",},
{"Haitian Creole","Haitian; Haitian Creole","haïtien; créole haïtien","hat","ht",},
{"Hausa","Hausa","haoussa","hau","ha",},
{"Hawaiian","Hawaiian","hawaïen","haw","",},
{"Hebrew","Hebrew","hébreu","heb","he",},
...
{"Imperial Aramaic (700-300 BCE)","Official Aramaic (700-300 BCE); Imperial Aramaic (700-300 BCE)","araméen d'empire (700-300 BCE)","arc","",},
{"Inari Sami","Inari Sami","sami d'Inari","smn","",},
{"Indic languages","Indic languages","indo-aryennes, langues","inc","",},
{"Indo-European languages","Indo-European languages","indo-européennes, langues","ine","",},
{"Indonesian","Indonesian","indonésien","ind","id",},
...
{"Irish, Old (to 900)","Irish, Old (to 900)","irlandais ancien (jusqu'à 900)","sga","",},
...
{"Judeo-Arabic","Judeo-Arabic","judéo-arabe","jrb","",},
{"Judeo-Persian","Judeo-Persian","judéo-persan","jpr","",},
...
{"Kalmyk","Kalmyk; Oirat","kalmouk; oïrat","xal","",},
...
{"Karelian","Karelian","carélien","krl","",},
...
{"Khoisan languages","Khoisan languages","khoïsan, langues","khi","",},
...
{"Korean","Korean","coréen","kor","ko",},
{"Kosraean","Kosraean","kosrae","kos","",},
{"Kpelle","Kpelle","kpellé","kpe","",},
...
{"Ladino","Ladino","judéo-espagnol","lad","",},
...
{"Leonese","Asturian; Bable; Leonese; Asturleonese","asturien; bable; léonais; asturoléonais","ast","",},
...
{"Macedo-Romanian","Aromanian; Arumanian; Macedo-Romanian","aroumain; macédo-roumain","rup","",},
{"Macedonian","Macedonian","macédonien","mac/mkd","mk",},
...
{"Mon-Khmer languages","Mon-Khmer languages","môn-khmer, langues","mkh","",},
{"Mong","Hmong; Mong","hmong","hmn","",},
{"Mongo","Mongo","mongo","lol","",},
{"Mongolian","Mongolian","mongol","mon","mn",},
{"Mossi","Mossi","moré","mos","",},
...
{"Ndebele, North","Ndebele, North; North Ndebele","ndébélé du Nord","nde","nd",},
{"Ndebele, South","Ndebele, South; South Ndebele","ndébélé du Sud","nbl","nr",},
...
{"Nias","Nias","nias","nia","",},
{"Niger-Kordofanian languages","Niger-Kordofanian languages","nigéro-kordofaniennes, langues","nic","",},
{"Nilo-Saharan languages","Nilo-Saharan languages","nilo-sahariennes, langues","ssa","",},
{"Niuean","Niuean","niué","niu","",},
{"No linguistic content","No linguistic content; Not applicable","pas de contenu linguistique; non applicable","zxx","",},
{"Nogai","Nogai","nogaï; nogay","nog","",},
{"Norse, Old","Norse, Old","norrois, vieux","non","",},
{"North American Indian languages","North American Indian languages","nord-amérindiennes, langues","nai","",},
{"North Ndebele","Ndebele, North; North Ndebele","ndébélé du Nord","nde","nd",},
...
{"Norwegian","Norwegian","norvégien","nor","no",},
{"Norwegian Bokmål","Bokmål, Norwegian; Norwegian Bokmål","norvégien bokmål","nob","nb",},
{"Norwegian Nynorsk","Norwegian Nynorsk; Nynorsk, Norwegian","norvégien nynorsk; nynorsk, norvégien","nno","nn",},
...
{"Nyankole","Nyankole","nyankolé","nyn","",},
{"Nynorsk, Norwegian","Norwegian Nynorsk; Nynorsk, Norwegian","norvégien nynorsk; nynorsk, norvégien","nno","nn",},
{"Nyoro","Nyoro","nyoro","nyo","",},
{"Nzima","Nzima","nzema","nzi","",},
{"Occidental","Interlingue; Occidental","interlingue","ile","ie",},
{"Occitan (post 1500)","Occitan (post 1500)","occitan (après 1500)","oci","oc",},
{"Occitan, Old (to 1500)","Provençal, Old (to 1500);Occitan, Old (to 1500)","provençal ancien (jusqu'à 1500); occitan ancien (jusqu'à 1500)","pro","",},
{"Official Aramaic (700-300 BCE)","Official Aramaic (700-300 BCE); Imperial Aramaic (700-300 BCE)","araméen d'empire (700-300 BCE)","arc","",},
{"Oirat","Kalmyk; Oirat","kalmouk; oïrat","xal","",},
{"Ojibwa","Ojibwa","ojibwa","oji","oj",},
{"Old Bulgarian","Church Slavic; Old Slavonic; Church Slavonic; Old Bulgarian; Old Church Slavonic","slavon d'église; vieux slave; slavon liturgique; vieux bulgare","chu","cu",},
{"Old Church Slavonic","Church Slavic; Old Slavonic; Church Slavonic; Old Bulgarian; Old Church Slavonic","slavon d'église; vieux slave; slavon liturgique; vieux bulgare","chu","cu",},
{"Old Newari","Classical Newari; Old Newari; Classical Nepal Bhasa","newari classique","nwc","",},
{"Old Slavonic","Church Slavic; Old Slavonic; Church Slavonic; Old Bulgarian; Old Church Slavonic","slavon d'église; vieux slave; slavon liturgique; vieux bulgare","chu","cu",},
{"Oriya","Oriya","oriya","ori","or",},
{"Oromo","Oromo","galla","orm","om",},
{"Osage","Osage","osage","osa","",},
{"Ossetian","Ossetian; Ossetic","ossète","oss","os",},
{"Ossetic","Ossetian; Ossetic","ossète","oss","os",},
...
{"Phoenician","Phoenician","phénicien","phn","",},
...
{"Prakrit languages","Prakrit languages","prâkrit, langues","pra","",},
{"Provençal, Old (to 1500)","Provençal, Old (to 1500);Occitan, Old (to 1500)","provençal ancien (jusqu'à 1500); occitan ancien (jusqu'à 1500)","pro","",},
...
{"Reserved for local use","Reserved for local use","réservée à l'usage local","qaa-qtz","",},
...
{"Scots","Scots","écossais","sco","",},
{"Scottish Gaelic","Gaelic; Scottish Gaelic","gaélique; gaélique écossais","gla","gd",},
{"Selkup","Selkup","selkoupe","sel","",},
{"Semitic languages","Semitic languages","sémitiques, langues","sem","",},
{"Sepedi","Pedi; Sepedi; Northern Sotho","pedi; sepedi; sotho du Nord","nso","",},
{"Serbian","Serbian","serbe","srp","sr",},
{"Serer","Serer","sérère","srr","",},
{"Shan","Shan","chan","shn","",},
...
{"Sino-Tibetan languages","Sino-Tibetan languages","sino-tibétaines, langues","sit","",},
...
{"South American Indian languages","South American Indian languages","sud-amérindiennes, langues","sai","",},
{"South Ndebele","Ndebele, South; South Ndebele","ndébélé du Sud","nbl","nr",},
...
{"Swedish","Swedish","suédois","swe","sv",},
{"Swiss German","Swiss German; Alemannic; Alsatian","suisse alémanique; alémanique; alsacien","gsw","",},
...
{"Tibetan","Tibetan","tibétain","tib/bod","bo",},
...
{"Tonga (Tonga Islands)","Tonga (Tonga Islands)","tongan (Îles Tonga)","ton","to",},
...
{"Zande languages","Zande languages","zandé, langues","znd","",},
{"Zapotec","Zapotec","zapotèque","zap","",},
