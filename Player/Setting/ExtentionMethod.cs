   ...
   public static  class ExtentionMethod 
    {
      public    const int LengthTrakBar = 50000;
       ...
       public static long GetCuterTime(this long TimeInPlayer, long DuratinInPlayer, long DuraitonInCuter)
       {
           return (TimeInPlayer * DuraitonInCuter) / DuratinInPlayer;
       }
       ...
       public static long  StringToMeliSec(this string  TimeString,double?  LastValue=0)
       {
           ...
           {
               XtraMessageBox.Show(Player.Setting.Utility.resourseMng.GetString("Bad_Format"));
